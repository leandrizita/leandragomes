...
const works = [
  { src: hero, title: "Esquina do café", year: "2019", tag: "Aquarela", span: "md:col-span-7" },
  { src: w1, title: "Museu Oscar Niemeyer - Encontro USK Brasil| Sul - Curitiba", year: "2019", tag: "Aquarela", span: "md:col-span-5" },
  { src: w4, title: "​Estação Central de metrô - Brasília/DF", year: "2019", tag: "AQUARELA E NANQUIM", span: "md:col-span-5" },
  ...
  { src: w7, title: "Jardim Botânico de Curitiba", year: "2019", tag: "Aquarela", span: "md:col-span-5" },
  { src: w11, title: "Estufa e visitantes", year: "2019", tag: "Aquarela", span: "md:col-span-7" },
